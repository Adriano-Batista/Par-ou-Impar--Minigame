...
#recorde de vitórias até fechar o jogo
best_sequence = 0
...
if wins > best_sequence:
    best_sequence == wins
    print("Parabéns. É um novo recorde!")

data = pd.read_csv(r"C:\Users\182200420\Desktop\Recorde_par_impar.csv")
df = pd.DataFrame(data, columns=["RANKING, NICKNAME, RECORD"])
print(df)
